    ...
    return (
        <>
            {/* <div className="groupL_modalBody" onClick={(e) => e.stopPropagation()}> */}
                ...
                <div className="groupL_modalRight">
                    <img className="groupL_modalImg" src={require("./login_icon.png")} />
                    <div className="groupL_modalRightHeader">
                        <span>2023. 02. 17</span>
                        <div className="groupL_modalRightHeaderRight">
                            <span>흐림</span>
                            <span>무지개</span>
                        </div>
                    </div>
                    <div className="groupL_middleLine"></div>
                    <hr id="groupL_middleLine" />
                    <p className="groupL_dairyContents">{dairyContents}</p>
                    <div>
                        <button className="groupL_modalCloseBtn">수정</button>
                        <button className="groupL_modalCloseBtn" onClick={modalClose}>닫기</button>
                    </div>
                    {props.children}
                </div>
            {/* </div> */}
